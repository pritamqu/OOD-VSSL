...
# copied from: https://github.com/showlab/EgoVLP/blob/main/base/base_dataset.py
...
class TextVideoDataset(Dataset):
    def __init__(self,
        ...
        if dataset_name == 'charadesego_text': # OOD special
            self.subset=subset
        ...
        self.split = split
        self.transforms = video_transform
        self.cut = cut
